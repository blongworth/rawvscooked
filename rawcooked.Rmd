...
sqlres <- paste0("SELECT wheel, target.tp_num, osg_num, runtime, sample_name, 
		    fm_corr, sig_fm_corr
                  FROM snics_results
...
```{r}
ggplot(data, aes(osg_num, he13_12.m, color = system)) +
  geom_point() + facet_grid(system ~ ., scales = "free_y")
ggplot(data, aes(osg_num, he13_12.s, color = system)) +
  geom_point() + facet_grid(system ~ ., scales = "free_y")
ggplot(data, aes(osg_num, he14_12.m, color = system)) +
  geom_point() + facet_grid(system ~ ., scales = "free_y")
ggplot(data, aes(osg_num, he14_12.s, color = system)) +
  geom_point() + facet_grid(system ~ ., scales = "free_y")
ggplot(data, aes(osg_num, fm_corr, color = system)) +
  geom_point() + facet_grid(system ~ ., scales = "free_y")
ggplot(data, aes(osg_num, fm_corr.s, color = system)) +
  geom_point() + facet_grid(system ~ ., scales = "free_y")
```
